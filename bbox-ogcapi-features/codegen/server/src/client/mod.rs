...
impl<F, C> Api<C> for Client<F> where
    ...
    fn describe_collection(&self, param_collection_id: String, context: &C) -> Box<dyn Future<Item=DescribeCollectionResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/collections/{collection_id}",
            self.base_path, collection_id=utf8_percent_encode(&param_collection_id.to_string(), ID_ENCODE_SET)
        );
                ...
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .and_then(|body|
                                serde_json::from_str::<models::Collection>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            DescribeCollectionResponse::InformationAboutTheFeatureCollectionWithId(body)
                        })
                ...
                500 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::Exception>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            DescribeCollectionResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
                ...
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::Collections>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            GetCollectionsResponse::TheFeatureCollectionsSharedByThisAPI(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                500 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetCollectionsResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
                ...
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::ConfClasses>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            GetConformanceDeclarationResponse::TheURIsOfAllConformanceClassesSupportedByTheServer(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                500 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetConformanceDeclarationResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
                ...
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::LandingPage>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            GetLandingPageResponse::TheLandingPageProvidesLinksToTheAPIDefinition(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                500 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetLandingPageResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn get_feature(&self, param_collection_id: String, param_feature_id: String, context: &C) -> Box<dyn Future<Item=GetFeatureResponse, Error=ApiError>> {
        let mut uri = format!(
            "{}/collections/{collection_id}/items/{feature_id}",
            self.base_path, collection_id=utf8_percent_encode(&param_collection_id.to_string(), ID_ENCODE_SET), feature_id=utf8_percent_encode(&param_feature_id.to_string(), ID_ENCODE_SET)
        );
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::FeatureGeoJson>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            GetFeatureResponse::FetchTheFeatureWithId(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                404 => {
                ...
                500 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetFeatureResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn get_features(&self, param_collection_id: String, param_limit: Option<i32>, param_bbox: Option<&Vec<f64>>, param_datetime: Option<String>, context: &C) -> Box<dyn Future<Item=GetFeaturesResponse, Error=ApiError>> {
        let mut uri = format!(
        ...
        if let Some(bbox) = param_bbox {
            query_string.append_pair("bbox", &bbox.join(","));
        }
        if let Some(datetime) = param_datetime {
            query_string.append_pair("datetime", &datetime.to_string());
        }
            ...
            match response.status().as_u16() {
                200 => {
                    ...
                    Box::new(
                        ...
                        .and_then(|body|
                            ...
                            .map_err(|e| ApiError(format!("Response was not valid UTF8: {}", e)))
                            .and_then(|body|
                                serde_json::from_str::<models::FeatureCollectionGeoJson>(body)
                                .map_err(|e| e.into())
                            )
                        )
                        .map(move |body| {
                            GetFeaturesResponse::TheResponseIsADocumentConsistingOfFeaturesInTheCollection(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                400 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetFeaturesResponse::AQueryParameterHasAnInvalidValue(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                404 => {
                ...
                500 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body| {
                            GetFeaturesResponse::AServerErrorOccurred(body)
                        })
                    ) as Box<dyn Future<Item=_, Error=_>>
                },
                code => {
